...
//     version 1.11.1
//     from Assets/scripts/_editor/controls/BattleInputs.inputactions
//
...
public partial class @BattleInputs: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""pre-battle"",
            ""id"": ""43bc1966-7d3e-41be-b812-e143bb8f6d65"",
            ""actions"": [
                {
                    ""name"": ""MouseLeftClick"",
                    ""type"": ""Button"",
                    ""id"": ""1e195c8b-6ba5-4d51-a139-b9a945f7c316"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""MouseRightClick"",
                    ""type"": ""Button"",
                    ""id"": ""c559d715-95b8-4745-836e-0de162cbf015"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""47e261e9-2476-4443-a5c9-2c1533e29e1a"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""4ca8262a-4868-454b-b797-8a5917af94d5"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        // pre-battle
        m_prebattle = asset.FindActionMap("pre-battle", throwIfNotFound: true);
        m_prebattle_MouseLeftClick = m_prebattle.FindAction("MouseLeftClick", throwIfNotFound: true);
        m_prebattle_MouseRightClick = m_prebattle.FindAction("MouseRightClick", throwIfNotFound: true);
    }

    ~@BattleInputs()
    {
        UnityEngine.Debug.Assert(!m_battle.enabled, "This will cause a leak and performance issues, BattleInputs.battle.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_strategy.enabled, "This will cause a leak and performance issues, BattleInputs.strategy.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_common.enabled, "This will cause a leak and performance issues, BattleInputs.common.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_cameramovement.enabled, "This will cause a leak and performance issues, BattleInputs.cameramovement.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_prebattle.enabled, "This will cause a leak and performance issues, BattleInputs.prebattle.Disable() has not been called.");
    }
    ...
    // pre-battle
    private readonly InputActionMap m_prebattle;
    private List<IPrebattleActions> m_PrebattleActionsCallbackInterfaces = new List<IPrebattleActions>();
    private readonly InputAction m_prebattle_MouseLeftClick;
    private readonly InputAction m_prebattle_MouseRightClick;
    public struct PrebattleActions
    {
        private @BattleInputs m_Wrapper;
        public PrebattleActions(@BattleInputs wrapper) { m_Wrapper = wrapper; }
        public InputAction @MouseLeftClick => m_Wrapper.m_prebattle_MouseLeftClick;
        public InputAction @MouseRightClick => m_Wrapper.m_prebattle_MouseRightClick;
        public InputActionMap Get() { return m_Wrapper.m_prebattle; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(PrebattleActions set) { return set.Get(); }
        public void AddCallbacks(IPrebattleActions instance)
        {
            if (instance == null || m_Wrapper.m_PrebattleActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PrebattleActionsCallbackInterfaces.Add(instance);
            @MouseLeftClick.started += instance.OnMouseLeftClick;
            @MouseLeftClick.performed += instance.OnMouseLeftClick;
            @MouseLeftClick.canceled += instance.OnMouseLeftClick;
            @MouseRightClick.started += instance.OnMouseRightClick;
        ...
        private void UnregisterCallbacks(IPrebattleActions instance)
        {
            @MouseLeftClick.started -= instance.OnMouseLeftClick;
            @MouseLeftClick.performed -= instance.OnMouseLeftClick;
            @MouseLeftClick.canceled -= instance.OnMouseLeftClick;
        ...
        public void RemoveCallbacks(IPrebattleActions instance)
        {
            if (m_Wrapper.m_PrebattleActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IPrebattleActions instance)
        {
            foreach (var item in m_Wrapper.m_PrebattleActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PrebattleActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public PrebattleActions @prebattle => new PrebattleActions(this);
    ...
    public interface IPrebattleActions
    {
        void OnMouseLeftClick(InputAction.CallbackContext context);
        void OnMouseRightClick(InputAction.CallbackContext context);
    }
