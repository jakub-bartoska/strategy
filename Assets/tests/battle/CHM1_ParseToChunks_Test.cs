namespace tests.testiky
{
    ...
    public class CHM1_ParseToChunks_Test : ECSTestsFixture
    {
        ...
        public void team1_team2()
        {
            ...
            var team1 = DataHolderUtils.getChunkByTeamPosition(singletonEntity, Team.TEAM1, manager);
            ...
            var team2 = DataHolderUtils.getChunkByTeamPosition(singletonEntity, Team.TEAM2, manager);
        ...
        public void team2_team1_team2()
        {
            ...
            var team2_1 = DataHolderUtils.getChunkByTeamPosition(singletonEntity, Team.TEAM2, manager, 1);
            ...
            var team2_2 = DataHolderUtils.getChunkByTeamPosition(singletonEntity, Team.TEAM2, manager, 0);
