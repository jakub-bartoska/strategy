...
namespace FullscreenEditor
{
    ...
    public unsafe class Patcher
    {
        ...
        public static bool IsSupported()
        {
            ...
            return CultureInfo.InvariantCulture.CompareInfo.IndexOf(SystemInfo.processorType, "ARM",
                CompareOptions.IgnoreCase) == -1 && Environment.Is64BitProcess;
        }
        ...
        public void SwapMethods()
        {
            ...
            unsafe
            {
                ...
                Logger.Debug("Relative jump is {0}available \\ {1}bit platform", relativeJumpAvailable ? "" : "not ",
                    sizeof(IntPtr) * 8);
