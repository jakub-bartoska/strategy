...
namespace FullscreenEditor
{
    ...
    public static class FullscreenRects
    {
        ...
        public static Rect GetFullscreenRect(RectSourceMode mode, ScriptableObject targetWindow = null)
        {
            ...
            {
                throw new ArgumentException("Target window must be of type EditorWindow or View or null",
                    "targetWindow");
            }
        ...
        {
            return Types.ContainerWindow.InvokeMethod<Rect>("FitRectToScreen",
                new Rect(Vector2.zero, Vector2.one * 10000f), true, mouseScreen);
        }
        ...
        {
            return container.InvokeMethod<Rect>("FitWindowRectToScreen", new Rect(Vector2.zero, Vector2.one * 10000f),
                true, mouseScreen);
        }
