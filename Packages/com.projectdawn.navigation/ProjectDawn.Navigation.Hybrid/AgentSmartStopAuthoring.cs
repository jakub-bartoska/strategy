...
namespace ProjectDawn.Navigation.Hybrid
{
    ...
    public class AgentSmartStopAuthoring : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField] protected HiveMindStop m_HiveMindStop = HiveMindStop.Default;
        ...
        /// </summary>
        public bool HasEntitySmartStop => World.DefaultGameObjectInjectionWorld != null &&
                                          World.DefaultGameObjectInjectionWorld.EntityManager
                                              .HasComponent<AgentSmartStop>(m_Entity);
