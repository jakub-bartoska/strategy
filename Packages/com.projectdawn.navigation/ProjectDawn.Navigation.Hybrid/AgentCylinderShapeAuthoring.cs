...
namespace ProjectDawn.Navigation.Hybrid
{
    ...
    public class AgentCylinderShapeAuthoring : MonoBehaviour
    {
        ...
        /// </summary>
        public bool HasEntityShape => World.DefaultGameObjectInjectionWorld != null &&
                                      World.DefaultGameObjectInjectionWorld.EntityManager.HasComponent<AgentShape>(
                                          m_Entity);
    ...
    internal class AgentCapsuleShapeBaker : Baker<AgentCylinderShapeAuthoring>
    {
        ...
        public override void Bake(AgentCylinderShapeAuthoring authoring) =>
            AddComponent(GetEntity(TransformUsageFlags.Dynamic), authoring.DefaultShape);
#else
