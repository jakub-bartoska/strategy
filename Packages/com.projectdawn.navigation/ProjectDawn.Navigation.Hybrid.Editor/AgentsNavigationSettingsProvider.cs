...
namespace ProjectDawn.Navigation.Editor
{
    class AgentsNavigationSettingsProvider : SettingsProvider
    {
        ...
        public AgentsNavigationSettingsProvider(string path, SettingsScope scopes, IEnumerable<string> keywords = null)
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            m_Settings =
                (AgentsNavigationSettings) EditorGUILayout.ObjectField(m_Settings, typeof(AgentsNavigationSettings),
                    false);
            ...
            else
            {
                EditorGUILayout.HelpBox(
                    $"Settings asset can be created by clicking menu item Assets>Create>AI>Agents Navigation Settings.",
                    MessageType.Info);
            }
            ...
            EditorGUI.HelpBox(controlRect,
                $"This feature should result better sonar avoidance, but for now it is experimental! Make sure commit changes, before turning it on.",
                MessageType.Info);
        ...
        static SettingsProvider CreateSettingsProvider() =>
            new AgentsNavigationSettingsProvider("Project/AgentsNavigation", SettingsScope.Project);
        ...
        {
            Rect lineRect =
                GUILayoutUtility.GetRect(GUIContent.none, Styles.lineStyle,
                    GUILayout.Height(1)); // Set the height of the line to 1
        ...
        static class Styles
        {
            public static readonly GUIContent SonarTimeHorizon = EditorGUIUtility.TrTextContent("Sonar Time Horizon",
                "Changes sonar avoidance radius to be based on velocity and also navmesh collision velocity accounts collision.");

            public static readonly GUIContent UseRegularUpdate = EditorGUIUtility.TrTextContent("Use Regular Update",
                "The enabled agents will use regular updates instead of fixed ones. Fixed updates provide a more deterministic motion and a lower possibility for agents to pass through.");
