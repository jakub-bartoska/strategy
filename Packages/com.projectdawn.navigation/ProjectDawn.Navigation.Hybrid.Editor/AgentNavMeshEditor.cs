...
namespace ProjectDawn.Navigation.Hybrid.Editor
{
    ...
    class AgentNavMeshEditor : UnityEditor.Editor
    {
        ...
        static class Styles
        {
            ...
            public static readonly GUIContent AreaMask =
                EditorGUIUtility.TrTextContent("Area Mask", "Specifies which NavMesh areas are passable. Changing areaMask will make the path stale (see isPathStale).");
            ...
            public static readonly GUIContent MappingExtent = EditorGUIUtility.TrTextContent("Mapping Extent",
